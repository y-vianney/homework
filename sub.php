        ...
        <main>
            <div class="data-table">
                <div class="data-table-top">
                    ...
                    <button><a href="http://localhost:8888/tests/bd/add.php">Ajouter</a></button>
                </div>
                <table>
                    <tr>
                        <th>MATRICULE</th>
                    ...
                    <?php foreach($rows as $row): ?>
                        <tr>
                            ...
                            <td style="width: 150px">
                                <a href="http://localhost:8888/tests/bd/update.php<?php echo "?id=" . $row[0] . "&name=" . $row[1] . "&pname=" . $row[2] . "&num=" . $row[3] ?>">
