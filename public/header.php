...
<div class="header">
    ...
    <div class="nav-bar">
        <ul>
            <li><a href="#">Home</a></li>
            <li><a href="http://localhost:8888/tests/bd/sub.php">Clients</a></li>
            <li><a href="http://localhost:8888/tests/bd/sub.php">Produits</a></li>
            <li><a href="http://localhost:8888/tests/bd/sub.php">Commandes</a></li>
        </ul>
    </div>
</div>
<script>
